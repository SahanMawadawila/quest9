...
int main()
{
    ...
    ofstream file("Customer_transactions.txt");         //writing the transactions to a seperate text file
    if (!file.is_open()) {
        std::cerr << "Error opening the file!\n";
        return 1;
    }
    
    file << setw(10) << "Customer" << setw(10) <<"Transaction"<<setw(10)<<endl;
                ...
                while (is_em_exit != 1)
                {
                    ...
                    case 1:                 //adding a new customer
                        ...
                        while (is_add_customer != 0)
                        {
                            ...
                            file <<setw(10)<<customer_name<< setw(10)<< st_balance << setw(10)<<endl;
    ...
    file.close();           //closing the reading file
